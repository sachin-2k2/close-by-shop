...
class _ImageSearchPageState extends State<ImageSearchPage> {
  ...
  Future<void> _uploadImage(File imageFile) async {
    ...
    try {
      var uri = Uri.parse('$baseurl/product/'); // Replace with your actual API endpoint
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Results Section
              if (!_loading && (_detectedText.isNotEmpty || _products.isNotEmpty))
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ...
                      else if (!_loading && _detectedText.isNotEmpty && _products.isEmpty)
                        Center(
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
